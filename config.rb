...
set :site_url, 'http://icebergh.us'
set :site_author, 'Orien Vandenbergh'
set :site_title, 'Icebergh'
set :site_description, 'A site, wherein, I write about things that interest me'
...
configure :build do
  ...
  activate :minify_javascript, :ignore => /.*\.user\.js$/
